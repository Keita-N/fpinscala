...
object Stream {
  ...
  def fromViaUnfold(n: Int): Stream[Int] = unfold(n)(i => Option(i, i + 1))
  def constantViafold[A](a: A): Stream[A] = unfold(a)(a => Option(a, a))
  def onesViaUnfold: Stream[Int] = constantViafold(1)
